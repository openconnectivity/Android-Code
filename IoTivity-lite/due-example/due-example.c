...
/*
 ...
 input_file            : /home/cstevens1/workspace/nomain/device_output/out_codegeneration_merged.swagger.json
...
post_binaryswitch(oc_request_t *request, oc_interface_mask_t interfaces, void *user_data)
{
  ...
  while (rep != NULL) {
    ...
    error_state = check_on_readonly_common_resource_properties(rep->name, error_state);rep = rep->next;
  }
...
int init;
  ...
  PRINT("Used input file : \"/home/cstevens1/workspace/nomain/device_output/out_codegeneration_merged.swagger.json\"\n");
